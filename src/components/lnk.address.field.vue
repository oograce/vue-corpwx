<!--
  ...
  @author siye
  @实例：
    Address: <lnk-address-field :province="accountItem.province"
                   :city="accountItem.city"
                   :district="accountItem.district"
  ...
  <div>
    ...
    <div class="lnk-field">
      <div class="lnk-row">
        ...
        <i class="iconfont icon-more" v-if="!readonly"></i>
      </div>
      <van-popup v-model="showAddressFlag" position="bottom">
        <van-area
          :area-list="areaList"
          :columns-num="3"
          title="选择地址"
...
<script>
  export default {
    ...
    methods: {
      ...
      onConfirmAddress: function ( value ) {
        this.showAddressFlag = false;
